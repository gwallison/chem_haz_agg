...
# --- Configuration ---
# File paths
INPUT_PATH = r"C:\MyDocs\integrated\chem_profiles\data\02_intermediate\echa_self_classifications.parquet"
OUTPUT_PATH = r"C:\MyDocs\integrated\chem_profiles\data\02_intermediate\echa_self_summary.parquet"
